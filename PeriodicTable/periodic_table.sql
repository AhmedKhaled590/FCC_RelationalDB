...
--
-- Name: properties fk_typeid; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_typeid FOREIGN KEY (type_id) REFERENCES public.types(type_id);
