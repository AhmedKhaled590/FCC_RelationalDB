...
echo "$($PSQL "select name from teams as t inner join games as g on g.winner_id=t.team_id where round='Final' and year=2018;")"

echo -e "\nList of teams who played in the 2014 'Eighth-Final' round:"
echo "$($PSQL "select name from teams as t inner join games as g on g.winner_id=t.team_id or g.opponent_id=t.team_id  where round='Eighth-Final' and year=2014 order by name;")"
